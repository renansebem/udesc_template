...
%\usepackage{abnt-alf}
%\usepackage{abnt-num}
%\usepackage[num]{abntcite} % ou \usepackage[alf]{abntcite} 	%, e outros comandos de citaï¿½ï¿½o disponï¿½veis nos pacotes.
...
\input{pre-textual/inicio}
\input{pre-textual/ficha_catalografica}

%Folha de arovaÃ§Ã£o sem assinatura:
\input{pre-textual/folhadeaprovacao}
%Quando a folha de aprovaÃ§Ã£o for assinada ela pode ser escaneada em pdf e adicionada aqui:
...
\defcaption{item da lista customizada}{bla}
